...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex) {
        String ct = (ex.getContentType() == null) ? "null" : ex.getContentType().toString();
        return buildResponse(HttpStatus.UNSUPPORTED_MEDIA_TYPE, "Content-Type non supporte: " + ct + ". Utilise multipart/form-data.");
    }
    ...
    public ResponseEntity<Object> handleGeneric(Exception ex) {
        log.error("Unhandled exception in document-service", ex);
